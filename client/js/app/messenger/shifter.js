...
define(['jquery', 'lodash', './chatInfo'], function($, _, chatInfo) {
	...
	return {
		...
		leftShift: function(){
			...
			var pop = _.remove(chatInfo.center, function(n){return n.is(_.first(chatInfo.center));})[0];
			var push = _.remove(chatInfo.right, function(n){return n.is(_.first(chatInfo.right));})[0];
		...
		rightShift: function(){
			...
			//configure chat windows to account of shift
			var pop = _.remove(chatInfo.center, function(n){return n.is(_.last(chatInfo.center));})[0];
			var push = _.remove(chatInfo.left, function(n){return n.is(_.last(chatInfo.left));})[0];
			push.width(pop.width());
